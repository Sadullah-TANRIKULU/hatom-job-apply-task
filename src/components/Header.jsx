    ...
    <div className="header-container">
      <div className="header-container-up">
        <div className="hatom-logo">
          <a href={url}>
            <img className="hatom-logo-img" src={logo} alt="hatom-logo" />
            <span className="hatom-logo-img">hatom</span>
          </a>
        </div>
        <div className="header-links">
          <ul>
            ...
            <li>
              <FormGroup>
                <FormControlLabel
                  control={<Switch defaultChecked style={{ color: "white" }} />}
                  label=""
                  size="small"
                />
              </FormGroup>
        ...
        <div className="btns">
          <button className="btn-elrond">
            {" "}
            <img src={logoElrond} alt="logo elrond" /> Elrond
          </button>
